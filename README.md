...
**오후 17:30 — 익일 일정. 이돈호 변호사(개인)·송무1팀·송무2팀 3회, 각 팀 안에서 변호사별로 분할.**
...
| `.github/workflows/evening.yml` | 매일 17:30 KST 익일 일정 알림(이돈호 개인, 송무1·2팀) |
...
오후 17:30 익일 알림은 **이돈호 변호사(개인) → 송무1팀 → 송무2팀** 순 3회 발송한다.
...
- 금요일 저녁에는 세 알림(이돈호 개인·송무1·2팀) 모두 **토·일·월 3일치를 한 메시지**로 묶어
  보낸다. 팀 알림은 3일치라 길어지므로 **묶음에 한해** 일정 없는 변호사 섹션은 생략한다
